...
/*   Updated: 2025/08/18 15:54:09 by gumendes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap " << name << " has been attacked receving " << amount << " points of damage!" << std::endl;
	hitPoints -= amount;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (energyPoints > 0 && hitPoints > 0)
	{
		std::cout << "ClapTrap " << name << " is repairing himself for " << amount << " hit points!" << std::endl;
		hitPoints += amount;
		energyPoints--;
	}
	else if (energyPoints <= 0)
		std::cout << "ClapTrap " << name << " has exausted all his energy and can't repair himself." << std::endl;
	else if (hitPoints <= 0)
		std::cout << "ClapTrap " << name << " has died hence he can't repair himself." << std::endl;
}
